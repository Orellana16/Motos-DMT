            ...
            <div class="hero__right">
                ...
                <div class="secondary-links">
                    <a href="#" class="secondary-links__link">
                        <svg class="secondary-links__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="social">
                    <a href="https://www.x.com" class="social__link">
                        <svg class="social__icon" fill="currentColor" viewBox="0 0 24 24">
                            <path
